...
<nav class="navbar navbar-expand-xl ">
            ...
            ?>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td data-label="Unit Price" style="font-size:20px;"><?php echo $product_price." mmk"; ?></td>
                                ...
                                <td data-label="Subtotal" style="font-size:20px;"><?php echo $subtotal." mmk"; ?></td>
    ...
    <div class="container">
        ...
        <div class=" float-none float-sm-none float-md-none float-lg-right float-xl-rightcheckout mr-0 p-2 border border-dark  " style="border-radius:5%;">
            ...
            <h2>Grand total = <?php echo $total." mmk"; ?> </h2>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-2 text-center">
                    ...
                    <p class="h6">Copy All rights Reserved.<a class="text-green ml-2" href="https://www.google.com" target="_blank">Fresher Farm</a></p>
                </div>
                </hr>
            </div>
        </div>
