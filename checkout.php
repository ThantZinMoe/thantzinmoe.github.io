...
<div class=" flex-row-reverse left ">
    ...
    <a class="float-left" href="bhome.php">
        <img src="agro.png" class="float-left mr-5 ml-0 " alt="Logo" style="height:80px;">
    </a>
</div>
...
<a class="float-left" href="bhome.php">
    <img src="agro.png" class="float-left mr-2 moblogo" alt="Logo" style="height:80px;">
</a>
...
<div class=" flex-row-reverse right ">
    ...
    <form action="checkout.php" method="post">
        ...
        <div class="container mt-2">
            ...
            <form>
                <div class=" float-none float-sm-none float-md-none float-lg-right float-xl-rightcheckout mr-0 p-2 mb-5   " style="border-radius:5%;">
                    <h4 style="font-family: sans-serif"><b>Grand total =  <?php echo $_SESSION['grandtotal']." mmk"; ?> </b></h4>
                </div>
                            ...
                            while ($phones = mysqli_fetch_array($run_get_phone)) {
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td data-label="Total"><?php echo $subtotal." mmk"; ?></td>
                                        <?php
        ...
        <div class="container mt-5">
            ...
            <div class="payment">
                <h4>
                    <input type="radio" aria-label="Radio button for following text input" name="payment" value="paytm" required><b>Online Payment</b>
                    <input type="radio" aria-label="Radio button for following text input" name="payment" value="cod" required><b>Cash on Delivery</b>
                </h4>
            </div>
    ...
    <div  class=" float-none float-sm-none float-md-none float-lg-left float-xl-left continueshopping mt-5">
        <a href="#" onclick="history.back();"><input type="submit" value="<<< BACK" class="btn btn-lg  border border-dark " style="font-size:22px;color:black;background-color:#FFD700"></a>
    </div>
    <div class=" float-none float-sm-none float-md-none float-lg-right float-xl-right mt-5">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-2 text-center">
                    <p>Fresher Farm is a Multitrading Company for farmers ang traders</p>
                    <p class="h6">Copy All right Reversed.<a class="text-green ml-2" href="https://www.google.com" target="_blank">Fresher Farm</a></p>
                </div>
                </hr>
            </div>
        </div>
