...
<body>
    ...
    <div class="container"> <img src="f2.jpg" class="img-fluid firstimage d-block mx-auto" alt="Responsive image">
    </div>
    <br>
    <br>
    ...
    <div class="container">
        ...
        <div class="text-center">
            <h1 id="headings" class="longguard"><span><b>Best Selling Products All Over Myanmar</b></span>
            </h1>
        </div>
        <br>
        <div class="row">
        ...
        <a href='../auth/BuyerLogin.php'><input type="submit" value="<<<BACK" class="btn btn-lg  border border-dark " style="font-size:22px;color:black;background-color:#FFD700"></a>
        </div>
<br><br><br><br><br>
    </div>
    </div>
