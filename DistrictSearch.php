...
<nav class="navbar navbar-expand-xl ">
          ...
          <div class="container">
               <div class="row   p-2">
                    ...
                    <div class="col-6 col-xl-3 col-lg-3 col-md-6 col-sm-6 districts">
                         ...
                         <select class="p-2 ml-5 shadow-lg" name="stateInput" id="state" style="border-radius: 6px; border-color: #FFD700 ">
     ...
     if (isset($_POST['go'])) {
          ...
          if ($stateInput != '0' && $cityInput == 'Select City') {
               echo "<script>window.open('StateSearch.php?state=$stateInput','_self')</script>";
          } else {
               echo "<script>window.open('CitySearch.php?city=$cityInput','_self')</script>";
          }
     }
